        ...
        <div class="col-12 m-auto">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    #2. menulis query
                    $tampil = "SELECT *, mahasiswas.nama as nm_mhs, dosens.nama as nm_dos, mahasiswas.email as email_mhs FROM mahasiswas INNER JOIN jurusans 
                    ON mahasiswas.jurusans_id=jurusans.id
                          ...
                          <div class="modal fade" id="detail<?=$data['nim']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">: <?=$data['email_mhs']?></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <th scope="col">: <?=$data['jurusan']?></th>
                                </tr>
                                <tr>
                                    <td scope="col">Nama Dosen</td>
                                    <th scope="col">: <?=$data['nm_dos']?></th>
                                </tr>
                                </table>
                                </div>
